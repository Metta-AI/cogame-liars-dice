...
test -s "${dist}/liars_dice_replay.wasm"
test -s "${dist}/liars_dice_replay.js"

rm -rf "${output_dir}"
mkdir -p "${output_dir}/assets"
cp "${dist}/liars_dice_replay.js" "${dist}/liars_dice_replay.wasm" \
  "${output_dir}/"
...
echo "liars-dice replay viewer bundle: ${output_dir}"
